...
def main():
    ...
    user_id = input("Enter User ID to authenticate (or press Enter to detect any user): ").strip()
    ...
    if user_id:
        ...
        aligned_path = os.path.join("auth_images", f"auth_{user_id}_{timestamp}_aligned.png")
    else:
        auth_path = os.path.join("auth_images", f"auth_unknown_{timestamp}.png")
        aligned_path = os.path.join("auth_images", f"auth_unknown_{timestamp}_aligned.png")
